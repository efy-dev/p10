package com.efeiyi.ec.wiki.master.controller;

import com.alibaba.fastjson.JSONObject;
import com.efeiyi.ec.master.model.*;
import com.efeiyi.ec.organization.model.MyUser;
import com.efeiyi.ec.organization.model.User;
import com.efeiyi.ec.wiki.base.model.LogBean;
import com.efeiyi.ec.wiki.base.util.WikiConfig;
import com.efeiyi.ec.wiki.master.model.MasterModel;
import com.efeiyi.ec.wiki.master.util.ConvertMasterModelUtil;
import com.efeiyi.ec.wiki.organization.util.DigitalSignatureUtil;
import com.efeiyi.ec.wiki.organization.util.JsonAcceptUtil;
    ...
    public Map MasterMessagePList(HttpServletRequest request) throws Exception {
        ...
        try {
          ...
          /*  if (verify != true) {
            ...
            MyUser user = (MyUser) baseManager.getUniqueObjectByConditions(WikiConfig.SQL_USER_GET, map);
