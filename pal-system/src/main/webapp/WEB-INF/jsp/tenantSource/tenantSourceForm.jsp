...
<div class="am-g">
    <form action="<c:url value='/tenantSource/saveTenantSource.do'/>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
        ...
        <div class="am-form-group">
            <label for="img" class="am-u-sm-3 am-form-label">溯源图片 <small>*</small></label>
            <div class="am-u-sm-9">
                <input type="file" id="img" name="img" placeholder="溯源图片"
                       value="${object.imgUrl}">
            </div>
