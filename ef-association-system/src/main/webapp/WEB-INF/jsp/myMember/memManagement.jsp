                    ...
                    <div class="am-btn-toolbar">
                        <div class="am-btn-group am-btn-group-xs" style="width: 100%;">
                            <button onclick="window.location.href='<c:url
                                    value="/myMember/memManagementForm.do?qm=memManagementForm_form&group=${group}&id=${document.id}&resultPage=/myMember/memManagement.do?qm=${requestScope.qm}"/>'"
                                    class="am-btn am-btn-default am-btn-xs am-hide-sm-only"><span
                                    class="am-icon-edit"></span> 编辑</button>
                            <button onclick="myConfirm('<c:url
                                    value="/myMember/removeMemManagement.do?id=${document.id}&resultPage=/myMember/memManagement.do?qm=${requestScope.qm}"/>', 'D');"
