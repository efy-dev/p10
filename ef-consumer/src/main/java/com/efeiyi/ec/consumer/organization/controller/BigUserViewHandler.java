package com.efeiyi.ec.consumer.organization.controller;//package com.efeiyi.ec.website.organization.controller;
//
...
//
//            modelMap.put("jsonData", XDoUtil.viewPageJson(tempPage, object, methodCache));
//        }
//
//
