...
<center>
    <form action="<c:url value="/basic/xmm.do"/>" method="post" enctype="multipart/form-data" class="am-form am-form-horizontal">
     <input type="hidden" name="qm" value="saveOrUpdateEnterpriseTenant">
      ...
      <table>
       ...
       <tr>
         <th>*税务登记证电子版</th>
         <td>
           <input type="file" id="taxRegistrationAttachment" name="taxRegistrationAttachment"/>
         </td>
       </tr>
       <tr>
         <th>*组织机构代码证电子版</th>
         <td>
           <input type="file" id="organizationAttachment" name="organizationAttachment"/>
         </td>
       </tr>
       <tr>
         <th>*银行开户许可证电子版</th>
         <td>
           <input type="file" id="bankAttachment" name="bankAttachment"/>
         </td>
       </tr>
       <tr>
         <td>
