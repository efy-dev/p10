                ...
                <div class="am-u-sm-9">
                    <div class="am-form-group am-form-icon">
                        ...
                        <input type="text" id="indateBegin" name="indateBegin" class="am-form-field am-input-sm"
                               placeholder="营业执照生效日期" value="${object.indateBegin}" data-am-datepicker readonly>
                    </div>
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <div class="am-form-group am-form-icon">
                        ...
                        <input type="text" id="indateEnd" name="indateEnd" class="am-form-field am-input-sm"
                               placeholder="营业执照失效日期"  value="${object.indateEnd}" data-am-datepicker readonly>
                    </div>
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <textarea type="text" id="businessScope" name="businessScope" placeholder="经营范围" cols="3" rows="4">${object.businessScope}</textarea>
                </div>
            </div>
            <div class="am-form-group">
                    ...
                    <div class="am-u-md-13">
                        <div class="am-panel am-panel-default">
                            <div class="am-panel-hd am-cf" data-am-collapse="{target: '#collapse-panel-1'}">
                                ...
                                <input type="hidden" name="businessLicense" value="${object.businessLicense}" placeholder="营业执照电子版">
                                <span class="am-icon-chevron-down am-fr"></span></div>
