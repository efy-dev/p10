    ...
    <form action="<c:url value="/product/saveNewProduct.do"/>" method="post" class="am-form am-form-horizontal" id="form">
        <fieldset>
            <legend>
                    ...
                    <a style="width: 10%;" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only" onclick="toSubmit('2','redirect:/basic/xm.do?qm=plistProduct_default&view=${view}&tenantId=${object.tenant.id}')"  href="javascript:void (0);">
                        返回列表
                    </a>

            </legend>
            <a style="width: 10%;" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"  href="<c:url value="/basic/xm.do?qm=formProduct&view=${view}&id=${object.id}&tenantId=${object.tenant.id}&masterId=${masterId}"/>">
                修改基本信息
            </a>
        ...
        <div class="am-form-group">
            <div class="am-u-sm-9 am-u-sm-push-3">
                    ...
                    <span style="padding: 10px;">
                             ...
                             <input type="button"  onclick="toSubmit('2','redirect:/basic/xm.do?qm=plistProduct_default&view=${view}&tenantId=${object.tenant.id}')" class="am-btn am-btn-primary" value="返回商品列表"/>
