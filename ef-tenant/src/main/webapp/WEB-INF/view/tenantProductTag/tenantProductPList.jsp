...
<div style="text-align: left;margin-bottom: 10px">
  <a type="button" class="am-btn am-btn-default am-btn-xs" href="<c:url value="/basic/xm.do?qm=viewTenantCategory&id=${tenantCategoryId}"/>"><span class="am-icon-plus"></span>返回</a>
</div>

<jsp:include page="/do/generateTabs.do?qm=${requestScope.qm}&conditions=${requestScope.conditions}&tenantCategoryId=${tenantCategoryId}"/>
