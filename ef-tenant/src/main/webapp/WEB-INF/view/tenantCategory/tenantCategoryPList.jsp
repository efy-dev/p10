...
<div class="admin-content">
    ...
    <div style="margin-left: 15px;">
        <input onclick="window.location.href='<c:url
                value="/basic/xm.do?qm=formTenantCategory"/>'"
                ...
                <table class="am-table am-table-bordered am-table-radius am-table-striped">
                    ...
                    <c:forEach items="${requestScope.pageInfo.list}" var="tenantCategory">
                        ...
                        <tr id="${tenantCategory.id}">
                                ...
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button onclick="window.location.href='<c:url
                                                value="/basic/xm.do?qm=formTenantCategory&id=${tenantCategory.id}"/>'"
                            ...
                            <td>
                                <a href="<c:url value="/basic/xm.do?qm=viewTenantCategory&id=${tenantCategory.id}" />">
