        ...
        <c:if test="${empty collectList}">
         ...
         <c:if test="${!empty collectList}">
          <ul class="list-number">
            ...
            <li class="single">
              <dl>
                <dt class="list-img"><a href="<c:url value="/product/productModel/${collectList.productModel.id}"/>"><img width="150"height="150" src="http://pro.efeiyi.com/${collectList.productModel.productModel_url}@!product-collect"></a></dt>
                <dd>
                  <dl class="list-title">
                    <%--<dt>--%>
                    ...
                    <%--</dt>--%>
                    <dd>
                      <p class="list-title-text"><a href="<c:url value="/product/productModel/${collectList.productModel.id}"/>" style="color: #666;font-size: 12px;">${collectList.productModel.product.name}</a>
