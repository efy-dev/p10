        ...
        <form action="<c:url value="/basic/xmm.do"/>" method="post" class="am-form am-form-horizontal"
            ...
            <div class="am-form-group">
                ...
                <c:if test="${!empty object.favicon}">
                    <img src="http://master.efeiyi.com/${object.favicon}@!master-manage-photo">
                </c:if>
            </div>
            ...
            <div class="am-form-group">
                ...
                <c:if test="${!empty object.backgroundUrl}">
                    <img src="http://master.efeiyi.com/${object.backgroundUrl}@!master-manage-photo">
                </c:if>
            </div>
            ...
            <div class="am-form-group">
                ...
                <c:if test="${!empty object.logoUrl}">
                    <img src="http://master.efeiyi.com/${object.logoUrl}@!master-manage-photo">
                </c:if>
            </div>
