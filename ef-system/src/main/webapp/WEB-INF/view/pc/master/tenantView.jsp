...
<div class="am-g">
    ...
    <div class="am-u-md-4" >
       ...
       <div class="" >
         <img src="http://master.efeiyi.com/${object.logoUrl}@!master-manage-banner">
       </div>
    </div>
    <div class="am-u-md-4">
        <label class="am-form-label">头像</label>
        <div class="">
            <img src="http://master.efeiyi.com/${object.favicon}@!master-manage-banner">
        </div>
    </div>
    ...
    <div class="am-u-md-4">
        ...
        <div class="">
            <img src="http://master.efeiyi.com/${object.backgroundUrl}@!master-manage-banner">
        </div>
    </div>
</div>
<div class="am-u-md-12">
...
<div class="am-g">
    ...
    <div class="am-u-md-12">
        <jsp:include flush="true"
                     page="/basic/xm.do?qm=listTenantProject_include&conditions=master.id:${object.id}"/>
    </div>
</div>
...
<div class="am-g">
    ...
    <div class="am-u-md-12">
        <jsp:include flush="true"
                     page="/basic/xm.do?qm=listTenantBanner_default&conditions=master.id:${object.id}"/>
    </div>
</div>
...
<div class="am-g">
    ...
    <div class="am-u-md-12">
        <jsp:include flush="true"
                     page="/basic/xm.do?qm=listTenantIntroduction_include&conditions=master.id:${object.id}&master.id=${object.id}"/>
    </div>
</div>
...
<div class="am-g">
    ...
    <div class="am-u-md-12">
        <jsp:include flush="true"
                     page="/basic/xm.do?qm=listTenantNews_include&conditions=master.id:${object.id}&tenantId=${object.id}"/>
    </div>
</div>
...
<div class="am-g">
    ...
    <div class="am-u-md-12">
        <jsp:include flush="true"
                     page="/basic/xm.do?qm=listTenantWorkShop_default&conditions=master.id:${object.id}&tenantId=${object.id}"/>
    </div>
</div>
