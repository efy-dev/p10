    ...
    <c:forEach items="${objectList}" var="masterNews">
        <tr id="${masterNews.id}">
                ...
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
                           href="<c:url value="/basic/xm.do?qm=formTenantNews&id=${masterNews.id}&tenantId=${masterNews.master.id}"/>"><span
                                class="am-icon-pencil-square-o"></span> 编辑
                        </a>
                        <a class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                          onclick="removeTenantNews('${masterNews.id}')"><span
            ...
            <td class="am-hide-sm-only"><a
                    href="<c:url value="/basic/xm.do?qm=viewTenantNews&id=${masterNews.id}"/>">${masterNews.title}</a>
            </td>
