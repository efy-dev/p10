    ...
    <%--<c:forEach items="${objectList}" var="tenantBanner" varStatus="banner">--%>
        <%--&lt;%&ndash;<c:if test="${banner.index % 3 == 0 && objectList.size() - 1 != banner.index}">&ndash;%&gt;--%>
            ...
            <%--<div class="am-u-sm-4" id="${tenantBanner.id}">--%>
                <%--<div class="am-thumbnail">--%>
                    <%--<img src="<c:url value="http://master.efeiyi.com/${tenantBanner.imageUrl}@!master-manage-photo"/>" alt=""/>--%>
    ...
    <table class="am-table am-table-striped am-table-hover table-main">
        ...
        <c:forEach items="${objectList}" var="tenantBanner" varStatus="banner">
            <tr id="${tenantBanner.id}">
                ...
                <td class="am-hide-sm-only"><img src="<c:url value="http://master.efeiyi.com/${tenantBanner.imageUrl}@!master-manage-banner"/>" alt=""/></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
