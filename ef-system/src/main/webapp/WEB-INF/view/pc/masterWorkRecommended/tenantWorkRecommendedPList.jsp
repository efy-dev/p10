                ...
                <table class="am-table am-table-striped am-table-hover table-main">
                    ...
                    <c:forEach items="${requestScope.pageInfo.list}" var="masterWork">
                        <tr id="${masterWork.id}">
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        ...
                                        <c:url value="/basic/xm.do?qm=saveOrUpdateTenantWorkRecommended&project.id=${projectId}&master.id=${tenantId}&masterWork.id=${masterWork.id}
                            ...
                            <td class="am-hide-sm-only"><a href="<c:url value="/basic/xm.do?qm=viewTenantWork&id=${masterWork.id}"/>">${masterWork.name}</a></td>
