...
<div class="am-g">
  ...
  <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
    <form action="<c:url value="/basic/xm.do"/>" method="post" class="am-form am-form-horizontal">
      ...
      <input  type="hidden" id="projectId" value="${object.product.project.id}" name="project.id">
      <div class="am-form-group">
        <label name="type"  class="am-u-sm-3 am-form-label">礼品名称 <small>*</small></label>
        <div class="am-u-sm-9">
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-9">
          <input type="hidden" name="product.id" id="productId" placeholder="" value="${object.product.id}" >
          <input type="text" name="product.name" id="productName" placeholder="" data-am-modal="{target: '#my-popup'}" value="${object.product.name}" required>
        </div>
      </div>
        ...
        <c:forEach var="product" items="${productList}">
          <tr name="${product.name}" serial="${product.serial}">
            <td align="center" width="33%">
              <a style="width: 10%;"
                 class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"
                 href="javascript:void(0);" onclick="selectObj('${product.id}','${product.name}','my-popup','product','${product.project.id}')">
                选择
              </a>
            </td>
