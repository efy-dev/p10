        ...
        <div class="am-btn-toolbar">
            <div class="am-btn-group am-btn-group-xs">
                <a type="button" class="am-btn am-btn-default"
                   href="<c:url value="/basic/xm.do?qm=viewMaster&id=${requestScope.pageInfo.list[0].master.id}"/>"><span
                        class="am-icon-plus"></span>返回大师页面</a>
                <a type="button" class="am-btn am-btn-default"
                   href="<c:url value="/basic/xm.do?qm=formwikiMasterWork&masterId=${requestScope.pageInfo.list[0].master.id}&projectId=${requestScope.pageInfo.list[0].project.id}"/>"><span
                    ...
                    <c:forEach items="${requestScope.pageInfo.list}" var="masterWork">
                        <tr id="${masterWork.id}">
                            <td>
                                <div class="am-btn-toolbar">
                                    <div class="am-btn-group am-btn-group-xs">
                                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary" href="<c:url value="/basic/xm.do?qm=formwikiMasterWork&id=${masterWork.id}&masterId=${masterWork.master.id}&projectId=${masterWork.project.id}"/>"><span
