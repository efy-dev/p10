...
<div class="am-g">
    ...
    <div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4">
        <form action="<c:url value="/basic/xmm.do"/>" method="post" class="am-form am-form-horizontal"
            ...
            <input type="hidden" value="saveOrUpdateWikiMasterWork" name="qm">
            ...
            <input type="hidden" name="resultPage"
                    value="redirect:/basic/xm.do?qm=plistMasterWorkwiki_byProject&conditions=project.id:${projectId};master.id:${masterId}&projectId=${projectId}&masterId=${masterId}"/>
