            ...
            <div class="am-u-sm-9">
                <div style="margin-top: 9px;">
                    ...
                    <input style="width: 30%" value="" type="text" id="startDateTime"
                           ...
                           name="startDateTime"/>
                    结束:
                    <input style="width: 30%" value="" id="endDateTime" type="text"
        ...
        <div class="am-form-group">
            ...
            <div class="am-u-sm-9" style="margin-top: 10px;">
                <ul style="list-style:none">
                    <li>
                        <img id="pictureHost" width="100px;"
                             src="<c:url value="http://pro.efeiyi.com/${object.pictureUrl}@!product-model"/>"
                             alt="上传封面"/>
                    </li>
                    <li>
                        <a id="btn_upload"></a>
                   ...
                   <%--</c:if>--%>
                    ...
                    <span style="padding: 10px;">
                        ...
                        <c:if test="${param.type=='home'}">
                            <input type="button" onclick="toSubmit('redirect:/basic/xm.do?qm=plistSubject_default')"
                                   class="am-btn am-btn-primary" value="保存"/>
                        </c:if>
                             <c:if test="${param.type=='gift'}">
                                 <input type="button"
                                        onclick="toSubmit('redirect:/basic/xm.do?qm=plistGiftSubject_default')"
                                        class="am-btn am-btn-primary" value="保存"/>
                             </c:if>
