    ...
    <c:forEach items="${objectList}" var="tenantWorkShop">
        <tr id="${tenantWorkShop.id}">
                ...
                <div class="am-btn-toolbar">
                    <div class="am-btn-group am-btn-group-xs">
                        <a class="am-btn am-btn-default am-btn-xs am-text-secondary"
                           href="<c:url value="/basic/xm.do?qm=formTenantWorkShop&id=${tenantWorkShop.id}&tenantId=${tenantWorkShop.master.id}"/>"><span
            ...
            <td class="am-hide-sm-only"><img
                    src="<c:url value="http://master.efeiyi.com/${tenantWorkShop.picture_url}@!master-manage-banner"/>"
                    alt=""/></td>
