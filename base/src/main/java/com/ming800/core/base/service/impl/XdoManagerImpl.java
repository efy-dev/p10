...
//            e.printStackTrace();
    ...
    public PageInfo listPage(Do tempDo, DoQuery tempDoQuery, String tempConditions, PageEntity pageEntity) throws Exception {
        ...
        return xdoDao.getPageByConditions(pageEntity, xQuery.getStringBuilder().toString(), xQuery.getQueryParamMap());  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public Object list(Do tempDo, DoQuery tempDoQuery, String tempConditions) throws Exception {
        ...
        return xdoDao.getObjectList(xQuery.getStringBuilder().toString(), xQuery.getQueryParamMap());  //To change body of implemented methods use File | Settings | File Templates.
    }
    ...
    public String generateTotalMoney(Do tempDo, DoQuery tempDoQuery, String tempConditions, String countField) {
        ...
        String queryStr = xQuery.getStringBuilder().toString();
