...
<div class="am-g am-g-fixed" style="max-width: 636px;">
  <div class="am-u-md-12" style="box-shadow: 0px 0px 2px #626262;">
    <div class="am-u-md-12" style="text-align: center ;"><h2 style=" margin-top: 1.6rem;">非遗协会申报注册</h2></div>
    <div class="am-u-md-12" style="text-align: center ;">${errMsg}</div>
    <form class="am-form am-form-horizontal" action="<c:url value="/myUser/registerLogin.do"/>" method="post" id="form" >
      ...
      <div class="am-form-group">
        ...
        <div class="am-u-sm-10">
          <input type="text" name="name" id="username" onblur="checkUserName()" placeholder="输入用户名">
