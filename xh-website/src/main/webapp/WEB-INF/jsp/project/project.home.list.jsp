...
<div class="wh directory">
  ...
  <ul class="list-img-txt">
    <c:forEach items="${objectList}" var="project" end="3">
      <li>
        <a href="<c:url value='/project/project.do?qm=plistProject_default&provinceid=${project.addressDistrict.addressCity.addressProvince.id}&type=${project.type}'/>" target="_self" title=""><img src="http://pro.efeiyi.com/<c:url value='${project.picture_url}'/>@!project-picture" alt=""/></a>
        <p>${project.name}</p>
      </li>
    </c:forEach>
  </ul>
