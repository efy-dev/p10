  ...
  <div class="hd">
    <div class="slide-left">
      ...
      <div class="wh directory">
        <div class="title">非遗名录<a class="btn-more" href="<c:url value='/project/project.do?qm=listAddressProvince_default'/>" title="更多">更多</a></div>
    ...
    <div class="slider-right">
      ...
      <div class="part">
        ...
        <ul class="ul-list-btn">
          ...
          <li><a href="<c:url value='/project/project.do?qm=listAddressProvince_default'/>" title="非遗名录"><i class="icon icon-2"></i>非遗名录</a></li>
