...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="<c:url value="/css/amazeui.min.css"/>">
  <link type="text/css" rel="stylesheet" href="<c:url value="/css/app.css"/>">
</head>
<body>
<div  class="header-search">
  <h1><a href="#"><img src="<c:url value="/images/logo.png"/>"></a></h1>
...
<div class="wh">
  <div class="hd">
    <div class="detail-index">
      <h1 style="text-align: center;margin-bottom:80px;">“e飞蚁”的平台价值</h1>
      <p class="img" style="margin-bottom:80px;"><img src="<c:url value="/upload/platform-1.jpg"/>"/></p>
      <p class="img" style="margin-bottom:80px;"><img src="<c:url value="/upload/platform-2.jpg"/>"/></p>
      <p class="img" style="margin-bottom:80px;"><img src="<c:url value="/upload/platform-3.jpg"/>"/></p>
      <p class="img" style="margin-bottom:80px;"><img src="<c:url value="/upload/platform-4.jpg"/>"/></p>
      <p class="img" style="margin-bottom:80px;"><img src="<c:url value="/upload/platform-5.jpg"/>"/></p>
    </div>
  </div>
</div>
<!-- //End--logo-search -->
<div class="footer">
  ...
  <ul class="imgbg">
    <li class="li-img1"></li>
    <li class="span"></li>
    <li class="li-img2"><a href="<c:url value="/main/do7"/>" ></a></li>
    <li class="span"></li>
    <li class="li-img3"></li>
  </ul>
  <div class="footer-bottom">
    <ul class="correlation">
      <li><a target="_blank" href="<c:url value="/main/aboutUs"/>">关于我们</a></li>
      <li><a target="_blank" href="<c:url value="/main/contactUs"/>">联系我们</a></li>
      <li><a target="_blank" href="<c:url value="/main/welcome"/>">诚聘英才</a></li>
      <li><a href="#">意见反馈</a></li>
      <li><a target="_blank" href="<c:url value="/main/helpCenter"/>">帮助中心</a></li>
      <li><a href="#">诚信保证</a></li>
    </ul>
...
document.write(unescape("%3Cspan id='cnzz_stat_icon_1255887869'%3E%3C/span%3E%3Cscript src='" + cnzz_protocol + "w.cnzz.com/q_stat.php%3Fid%3D1255887869' type='text/javascript'%3E%3C/script%3E"));
</script>
<!-- //End--logo-search -->
<!--[if (gte IE 9)|!(IE)]><!-->
