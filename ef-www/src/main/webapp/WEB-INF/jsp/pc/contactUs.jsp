...
<!--<div class="hd">-->
<!--<div class="logo fl"><a href="http://www.efeiyi.com/" title="e飞蚁"></a></div>-->
<!--</div>-->
<!--</div>-->
<!-- //End--logo-search -->
...
<div class="content-header">
  <div class="content-head">联系我们</div>
  <div style="text-align: center"><img src="<c:url value="/upload/lx1.jpg"/>"></div>
  <ul class="lx3">
    <li>地 址：北京市朝阳区酒仙桥东路9号电子城A2西侧6层 </li>
    <li>Add：10th Floor,East Tower,Prosper Center,No5 Guanghua</li>
    <li>邮 箱：efeiyi@efeiyi.com </li>
    <li>Road,Chaoyang District,Beijing.100020</li>
    <li>电 话：010-56125616</li>
    <li>E-mail：efeiyi@efeiyi.com</li>
    <li>邮 编 ：100020</li>
    <li>Tel：+86-10-56125616 </li>
    <li></li>
    <li>Post：100020</li>
  </ul>
</div>
...
<div class="footer">
  ...
  <ul class="imgbg">
    <li class="li-img1"></li>
    <li class="span"></li>
    <li class="li-img2"><a target="_blank" href="<c:url value="/main/do7"/>" ></a></li>
    <li class="span"></li>
    <li class="li-img3"></li>
  </ul>
