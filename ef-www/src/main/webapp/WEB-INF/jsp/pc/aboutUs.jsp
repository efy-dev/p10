...
<div class="content-header">
  <div class="content-head">关于我们</div>
  <div class="content-gywm">
    <img src="<c:url value="/upload/gy1.jpg"/>">
    <img src="<c:url value="/upload/gy2.jpg"/>">
    <img src="<c:url value="/upload/gy3.jpg"/>">
    <img src="<c:url value="/upload/gy4.jpg"/>">
    <img src="<c:url value="/upload/gy5.jpg"/>">
  </div>
</div>
<!--//End--news-list--><div class="footer">
  <ul class="hd">
