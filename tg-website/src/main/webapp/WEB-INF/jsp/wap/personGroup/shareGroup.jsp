    ...
    <div class="c-content ae">
      <div class="co-page">
        <div class="introduce ae">
          ...
          <div class="button ae"><a href="http://mall.efeiyi.com/product/productModel/${group.groupProduct.productModel.id}" class="gbtn"><span>原价直接购买</span><i class="icon1"></i></a></div>
        </div>
        <%--<div class="tab-btn">--%>
