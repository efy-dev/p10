...
<![endif]-->
<script src="<c:url value="/scripts/assets/pc/js/system.js?v=929"/>"></script>
...
<div class="footernew wh">
    ...
    <div class="max-links wh">
        <div class="links wh">
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.gywm" target="_blank" title="关于我们"><i class="icon"></i>关于我们</a>
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.ptys" target="_blank" title="平台优势"><i class="icon"></i>平台优势</a>
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.cpyc" target="_blank" title="诚聘英才"><i class="icon"></i>诚聘英才</a>
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.lxwm" target="_blank" title="联系我们"><i class="icon"></i>联系我们</a>
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.yjfk" target="_blank" title="意见反馈"><i class="icon"></i>意见反馈</a>
            <a href="http://www.efeiyi.com/document/aboutUs?group=ec.fyjj" target="_blank" title="非遗简介"><i class="icon"></i>非遗简介</a>
        </div>
        <div class="copyright wh">
