...
<div style="text-align: left;margin-left: 10px;">
    <button onclick="window.location.href='<c:url value="/myHeritageProject/heritageProjectForm.do?qm=heritageProjectForm_form&group=${group}&resultPage=/myHeritageProject/heritageProject.do?qm=${requestScope.qm}"/>'"
