...
<head>
    ...
    <style>
        @media (width: 320px) {
            .list-class .ul-list li {
                height: 17rem
            }

            .list-class .ul-list li img {
                height: 11.2rem
            }
        }
...
<body>
<artice class="custom">
    <div data-am-widget="slider" class="am-slider am-slider-a1 details-shop-slider"
    ...
    <div class="details-shop-des">
        <div class="bd details-shop">
            <div class="bd s-part">
                <div class="img"><img src="<c:url value="http://pro.efeiyi.com/${tenant.logoUrl}@!tenant-wap-log"/>"
                                      width="80" alt=""/></div>
                <div class="bd txt">
                    <p>${tenant.name}</p>
                    <p>200人关注</p>
                ...
                <c:forEach items="${productModelList}" var="productModel">
                    <li>
                        <a href="/product/productModel/${productModel.id}" style="color: #000">
                            <img src="<c:url value="http://pro.efeiyi.com/${productModel.productModel_url}@!product-model-wap-tenant"/>"
                                 alt="">
                            <c:set var="name">
