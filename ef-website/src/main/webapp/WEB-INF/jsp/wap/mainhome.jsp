...
<div class="home">
    <header class="bd">
        ...
        <div class="icons">
            ...
            <a class="icon-home icon-cart" href="http://i.efeiyi.com/order/myEfeiyi/list.do"
               title=""><span><em></em></span></a>
            <%} else {%>
            <a class="icon-home icon-cart" href="<c:url value="/login"/>" title=""><span style="text-align: center;"><em
                    id="cartAmount"></em></span></a>
            <%}%>
    ...
    <div class="bd">
        <nav class="nav">
            ...
            <a href="http://gift.efeiyi.com" title="非遗礼品"><span class="bd"><i
                    class="icon-home icon3"></i></span>非遗礼品</a>
            <a href="http://mall.efeiyi.com" title="非遗电商"><span class="bd"><i
                    class="icon-home icon4"></i></span>非遗电商</a>
            ...
            <dd>
                <c:if test="${not empty marketingActivityQueryList&&fn:length(marketingActivityQueryList)>0}">
                    <c:forEach items="${marketingActivityQueryList}" var="marketingActivity" begin="0" end="0">
                        <div class="bd"><a href="${marketingActivity.redirect}"><img
                                src="http://pro.efeiyi.com/${marketingActivity.img}@!pc-home-marketing-activity" alt=""></a>
                        </div>
                    </c:forEach>
                </c:if>
                <div class="bd">
    ...
    <div class="bd">
        <div class="cpb">
            ...
            <div class="bd" style="margin-top: 25px;"><img src="<c:url value="/scripts/wap/images/home-cpb2.png"/>"
                                                           alt=""></div>
        </div>
    </div>
    <!--//End--诚品宝-->
    ...
    <div class="bd">
        <footer>
            ...
            <div class="bd content">
                <div class="bd wechat">
                    <div class="bd">
                        <div class="icon-home icon-logo"></div>
                    </div>
