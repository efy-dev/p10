...
<div class="commodity">
  <div class="discount">
   ...
   <c:forEach items="${collectList}" var="collectList">
      <div class="act-wid">
        <dl>
          <dt><a href="#"><img width="150"height="150" src="http://pro.efeiyi.com/${collectList.productModel.productModel_url}@!product-icon"></a></dt>
          <dd>
            <p class="commodity-bt">${collectList.productModel.product.name}</p>
