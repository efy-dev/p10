      ...
      <c:forEach items="${order.purchaseOrderProductList}" var="purchaseOrderProduct">
        <div class="order-js-list">
          ...
          <div class="am-g am-intro-bd">
            <div class="am-intro-left am-u-sm-5 item-act"><a href="#"><img class="am-u-sm-12 item-act" src="<c:url value="${purchaseOrderProduct.productModel.productPicture.pictureUrl}"/>" alt="产品" /></a></div>
