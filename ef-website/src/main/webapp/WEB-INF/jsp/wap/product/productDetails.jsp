...
<script type="text/javascript">
	...
	_mvq.push(['$addGoods', /*商品名称*/ '${productModel.name}', /*商品ID*/ '${productModel.id}', /*商品售价*/ '${productModel.price}', /*商品图片url*/ 'http://pro.efeiyi.com/${productModel.productModel_url}',
	 /*分类名*/ '${productModel.product.project.name}', /*商品库存状态1或是0*/'${productModel.product.status}']);
	_mvq.push(['$logData']);
</script>
</body>
