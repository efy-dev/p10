...
<article class="custom">
    ...
    <div class="bd details slnew seckill">
        ...
        <div class="bd des-price">
            <c:if test="${not empty productModel.marketPrice&&productModel.product.status==1&&productModel.status!=0 && productModel.price.intValue()!=0}">
                <p class="bd t1"><span>市场价：</span>
                    <del>${productModel.marketPrice}</del>
                </p>
            </c:if>
            <c:if test="${not empty productModel.price&&productModel.product.status==1&&productModel.status!=0 && productModel.price.intValue()!=0}">
