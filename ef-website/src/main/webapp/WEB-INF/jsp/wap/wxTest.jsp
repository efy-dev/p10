...
<script>
    ...
    var wx_share_title = "测试标题"; //分享标题
    var wx_share_des = "测试描述";  //分享描述
    var wx_share_link = "http://www.efeiyi.com/wx/wxTest.do"; //分享的链接地址  //需要动态获取，而不是直接填写静态值
    var wx_share_imgUrl = ""; //分享图片的url
    var wx_share_type = 'http://ec-efeiyi.oss-cn-beijing.aliyuncs.com/Clipboard%20Image.png';   //分享的类型   分享类型,music、video或link，不填默认为link
