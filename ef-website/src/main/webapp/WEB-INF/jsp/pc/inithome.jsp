    ...
    <div class="hd">
        ...
        <div class="main">
            <div class="form">
                <form action="http://mall.efeiyi.com/search.do" method="get">
                    <input type="text" class="txt"
                           value="<c:if test="${searchParamBean.q != '*'}">${searchParamBean.q}</c:if>" name="q"
                           id="q">
            ...
            <div class="clinks">
                ...
                <a class="item second" href="http://<%=PConst.WEBSITE_MALL_HOST%>/document/helpCenter?group=ec.rzlc"
                   title="">商户免费入驻</a>
            ...
            <div class="main-left">
                    ...
                    <div class="m-box">
                        <div class="m-animate">
                            <ul>
                                <li>
                                    <a href="http://yaohuifen.efeiyi.com">
                                        <img src="<c:url value="/scripts/upload/姚慧芬.jpg"/>" alt=""
                                             date-h="苏绣国家级非遗传承人姚惠芬"
                                             date-txt="出生于苏州刺绣世家，自幼就开始学习刺绣。师从近代苏绣“仿真绣”大师沈寿的第三代传人牟志红和中国工艺美术大师任嘒娴。">
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihy6pqjo1dizwlaa">
                                        <img
                                ...
                                <li>
                                    <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/if3l43hd1h2oyvov">
                                        <img
                    ...
                    <div class="news">
                        <div class="newest">
                            <div class="consult">
                                <h5>新品上架</h5>
                                <ul>
                                    <li><a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ijw78fl93dqtd4xj">猫蝶图天然水晶内画壶:大师之作
                                        传世之物 罕见珍品</a></li>
                                    <li><a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ijy2r09wbpav1jly">九龙呈瑞盘:高档摆件
                                        金龙祥瑞 极佳寓意 乔迁好礼</a></li>
                                    <li><a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/il7ubj9p34n0qowg">高官厚禄得意长:闻名于世的真正的芦苇画，世界稀有孤品。最具收藏价值！</a>
                                    </li>
                                    <li><a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/igdcsu0v3sa6nhb5">崖柏盘香:纯天然室内熏香养生安神助眠老料香薰</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="west-pic">
                            <div class="w-pic">
                                <a href=""><img src="<c:url value="/scripts/upload/zhutu320151123180151.jpg"/>"
                                                alt=""><span>吉祥佛黑檀</span></a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <ul>
                        <li>
                            <a href="http://zhubingren.efeiyi.com/" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-1-1.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://yaohuifen.efeiyi.com/" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-1-2.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://weilizhong.efeiyi.com/" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-1-3.jpg"/>" alt=""></p>
                                <p class="info">
                ...
                <div class="items wiki">
                    ...
                    <ul>
                        <li>
                            <a href="http://<%=PConst.WEBSITE_WIKI_HOST%>/project/inlcj19o29sjxcah" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-2-1.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_WIKI_HOST%>/project/inl4on7x7tuttm3x" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/三花马-蓝色20151026115356.jpg"/>"
                                                    alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_WIKI_HOST%>/project/inl4q8a9320k7jmk" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-2-3.jpg"/>" alt=""></p>
                                <p class="info">
                ...
                <div class="items gift">
                    ...
                    <ul>
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihokg0wj2tek3fzo" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-1.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ijwo0vqfzvc1zu0t" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-2.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/igvu2io13czbwif1" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-3.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihykdmfn1k8httnz" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-4.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihbo02nj24x1v68o" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-5.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ief3hjp46b9jk29l" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-3-6.jpg"/>" alt=""></p>
                                <p class="info">
                ...
                <div class="items edify">
                    ...
                    <ul>
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/iefgxes915akvek5" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-4-1.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ighrk1id384nfu6r" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-4-2.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/igrin2dh3cdj6gi1" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-4-3.jpg"/>" alt=""></p>
                                <p class="info">
                ...
                <div class="items stone">
                    ...
                    <ul>
                        <li>
                            <a href="" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/120151027164330.jpg"/>" alt="">
                                </p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihd4sf6rgc6hjwnx" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-5-2.jpg"/>" alt=""></p>
                                <p class="info">
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/ihmqo94q19dvqlvy" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/home-pic-5-3.jpg"/>" alt=""></p>
                                <p class="info">
            ...
            <div class="main-slide">
                <div class="bd mbox1">
                    <a href="" class="" title=""><p class="img"><img class="imgbg"
                                                                     src="<c:url value="/scripts/upload/1000000.jpg"/>"
                                                                     alt=""></p></a>
                ...
                <div class="bd mbox2">
                    ...
                    <ul class="items">
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/im1ks2wy24egdx4q" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/主图220160321140311.jpg"/>" alt="">
                                </p>
                                <p class="name">新品上市</p>
                                <p class="info">藏山香盒</p>
                            </a>
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/in031lv24bmyuc9h" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/120160414172814.jpg"/>" alt="">
                                </p>
                                <p class="name">秒杀活动</p>
                        ...
                        <li>
                            <a href="http://<%=PConst.WEBSITE_MALL_HOST%>/product/productModel/imret0bt539jqhyk" title="">
                                <p class="img"><img class="imgbg"
                                                    src="<c:url value="/scripts/upload/主图320160408154741.jpg"/>" alt="">
                                </p>
                                <p class="name">拼团活动</p>
