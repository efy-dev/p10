...
<div class="top2016">
    <div class="hd">
        <ul class="fr">
            ...
            <li class="cart"><a href="<c:url value="/cart/view"/> " title=""><i class="icon-cart"></i><span
                    class="icon-num"><i id="cartAmount"></i></span></a></li>
...
<div id="slide2016" class="slide2016">
    <div data-am-widget="slider" class="am-slider am-slider-default" data-am-slider='{"controlNav":false}'
         data-am-flexslider="{playAfterPaused: 2000}" data-am-slider='{&quot;directionNav&quot;:false}'>
        <ul class="am-slides">
            <c:if test="${not empty bannerList&&fn:length(bannerList)>0}">
                <c:forEach items="${bannerList}" var="banner">
                    <li><a href="<c:url value="${banner.directUrl}"/>"><img
                            src="http://pro.efeiyi.com/${banner.imageUrl}"></a></li>
                </c:forEach>
            </c:if>
        </ul>
    </div>
                            ...
                            <div class="layer">
                                <ul>
                                    ...
                                    <c:forEach items="${projectMap.get(projectCategory.id)}" var="project">
                                        <li><a href="<c:url value="/product/list/${project.id}"/>"
                        ...
                        <li class="big">
                            <a href="${marketingActivity.redirect}" title="" target="_blank">
                                <p class="img"><img class="imgbg"
                                                    src="http://pro.efeiyi.com/${marketingActivity.img}@!pc-main-marketing-picture"
                                                    alt=""></p>
                            </a>
                        </li>
                    </c:forEach>
                        ...
                        <li>
                            <a href="${hotSale.redirect}" title="" target="">
                                <div class="img"><img class="imgbg"
                                                      src="http://pro.efeiyi.com/${hotSale.img}@!pc-main-product-picture"
                                                      alt=""></div>
                                <div class="info">
                ...
                <div class="mlist">
                    <c:if test="${not empty masterList&&fn:length(masterList)>0}">
                        ...
                        <div class="list" style="padding: 26px 20px">
                            <dt class="dhead"><a href="http://${masterList.get(0).getName()}.efeiyi.com"><img
                                    src="http://tenant.efeiyi.com/${masterList.get(0).getFavicon()}@!pc-main-master-picture"
                                    alt=""/></a></dt>
                            <dd class="dbody">
                                <div class="mtext">
                                ...
                                <ul class="mtime">
                                    <c:forEach items="${masterNewsMap.get(masterList.get(0))}" var="news" begin="0"
                                               end="2">
                                        <li class="tlist">
                                            <a href="http://yaohuifen.efeiyi.com/info/${news.id}">
                                                <div class="time"><fmt:formatDate value="${news.createDateTime}"
            ...
            <div class="mbody">
                    ...
                    <c:forEach items="${subjectList}" var="subject" begin="0" end="1">
                        <li>
                            <a href="http://gift.efeiyi.com/viewSubject/${subject.id}">
                                <img src="http://gift-oss.efeiyi.com/${subject.pictureUrl}@!pc-main-gift-picture"
                                     alt="">
                ...
                <div class="mform">
                            ...
                            <div class="fl wb" style="position: relative">
                                ...
                                <ul class="option" style="display: none">
                                    <c:forEach items="${map.value}" var="productGiftTagValue">
                                        <li>
                                            <a href="http://gift.efeiyi.com/getProductGiftpList?value=${productGiftTagValue.value}&minPrice=&maxPrice=">${productGiftTagValue.value}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                    ...
                    <div class="fl wb mgift">
                        ...
                        <div class="fl wb" style="position: relative">
                            <div class="select"
                                 href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=0&maxPrice=100"><a>百元以内</a>
                            </div>
                            <ul class="option" style="display: none">
                                <li><a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=0&maxPrice=100">百元以内</a>
                                </li>
                                <li>
                                    <a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=100&maxPrice=1000">100~1000</a>
                                </li>
                                <li>
                                    <a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=1000&maxPrice=5000">1000~5000</a>
                                </li>
                                <li>
                                    <a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=5000&maxPrice=10000">5000~1万</a>
                                </li>
                                <li>
                                    <a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=10000&maxPrice=100000">1万~10万</a>
                                </li>
                                <li>
                                    <a href="http://gift.efeiyi.com/getProductGiftpList?value=&minPrice=100000&maxPrice=1000000000">10万以上</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <input class="mbtn" type="submit" value="查找礼品"
                           onclick="location.href='http://gift.efeiyi.com/getProductGiftpList'"
                           style="margin: 12px 0;"/>
                    <%--</form>--%>
                </div>
            </div>
                            ...
                            <a href="http://minglu.efeiyi.com/minglu/project/${artistry.id}" title="" target="">
                                ...
                                <div class="info">
                                    ...
                                    <p class="txt2"><ming800:status name="level" dataType="Project.level"
                                                                    checkedValue="${artistry.getLevel()}"
                                                                    type="normal"></ming800:status>非遗项目</p>

                                </div>
                                <div class="intl"><img src="<c:url value="/scripts/images/intl-efeiyi.png"/>" alt=""/>
                                </div>
                            </a>
                        </li>
                    </c:forEach>
