...
<div class="hd">
    ...
    <c:forEach items="projectList" var="project">
        <div class="box-hd wh">
            ...
            <div class="list-pro">
                <ul class="ul-item">
                    <c:forEach items="${recommendMap.get(project.id)}" var="product">
                        <c:if test="${product.count%2==0}">
                            <c:set var="style" value="even"/>
                        </c:if>
                        <c:if test="${product.count%2==1}">
                            <c:set var="style" value="odd"/>
                        </c:if>
                        <li class="${style}"><a href="" target="_blank"
                                                title="${product.name}"><strong>${product.name}</strong><span
        ...
        <div class="list-pep wh">
            <ul class="ul-item">
                <c:forEach items="masterList" var="master">
                    <li>
                        <a href="" target="_blank"><img class="imgfilter" src="http://tenant.efeiyi.com${favicon}" alt=""/></a>
