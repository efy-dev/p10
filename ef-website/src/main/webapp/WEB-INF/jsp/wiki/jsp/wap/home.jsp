...
<header id="header" class="am-header custom-header index-header newheader">
    <div class="logo"><a class="icon" style="background:none;width:100px;" href="" title="e飞蚁"><img
    ...
    <div data-am-widget="slider" class="am-slider am-slider-a4 img-slider"
        ...
        <ul class="am-slides">
            <c:forEach items="${wapBannerList}" var="banner">
                <li>
                    <a href="<c:url value="${banner.directUrl}"/>" title=""><img
                            src="http://wiki-oss.efeiyi.com/${banner.imageUrl}@!wap-home-banner" alt=""></a>
                </li>
            </c:forEach>
        </ul>
    </div>
    ...
    <div class="list bd">
        ...
        <ul class="ul-col-2">
            <c:forEach items="${artRecommendList}" var="art" begin="0" end="3">
                <li>
                    <a href="<c:url value="/minglu/project/${art.artistry.id}"/>" title="">
                        <img src="http://wiki-oss.efeiyi.com/${art.artistry.getMainPicture().pictureUrl}@!wiki-project-picture"
                             alt="">
                        <span class="txt">
    ...
    <div class="list bd">
        ...
        <ul class="ul-col-2">
            <c:forEach items="${craftRecommendList}" var="craft" begin="0" end="3">
                <li>
                    <a href="<c:url value="/minglu/project/${craft.artistry.id}"/>" title="">
                        <img src="http://wiki-oss.efeiyi.com/${craft.artistry.getMainPicture().pictureUrl}@!wiki-project-picture"
                             alt="">
                        <span class="txt">
                        <p>${craft.artistry.name}</p>
                        <p><ming800:status name="level" dataType="Project.level"
                                           checkedValue="${craft.artistry.project.getLevel()}" type="normal"/>非遗项目</p>
                    </span>
                    </a>
                </li>
            </c:forEach>
