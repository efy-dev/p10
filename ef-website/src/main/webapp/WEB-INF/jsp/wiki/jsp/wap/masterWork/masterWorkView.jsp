...
<div class="worksView">
    <div class="workds-top bd bgfff">
        <div data-am-widget="slider" class="am-slider am-slider-a4 works-slider"
        ...
        <div class="works-box bd">
            <div class="works-page bd txt-c">
                ...
                <c:if test="${work.audio != null && work.audio != ''}">
                    <div class="audio bd">
                        <audio style="width:100%;float:left;" controls="controls"
                               src="http://tenant.efeiyi.com/${work.audio}" id="audio"></audio>
                    </div>
                </c:if>
            ...
            <div class="works-page2 bd">
                ...
                <div class="master_img">
                    <div class="img"><img src="<c:url value='http://tenant.efeiyi.com/${work.masterFavicon}'/>" alt="">
                    </div>
        ...
        <div class="ul-col2 bd">
            <ul>
                ...
                <c:forEach items="${work.workList}" var="works">
                    <li>
                        <a href="<c:url value="/minglu/masterWork/${works.id}"/>" title="">
                            <img src="<c:url value='http://tenant.efeiyi.com/'/>${works.pictureUrl}@!wiki-masterworks-picture"
                                 alt="">
                            <span class="fz11 black omitted">${works.name}</span>
                        </a>
                    </li>
