...
<div class="craft-particulars2016">
  <div class="craft-crumbs">
    <div class="particulars">
      <div class="crumbs"><a href="http://minglu.efeiyi.com" >首页</a><em class="">></em><a href="http://minglu.efeiyi.com" class=""><ming800:status name="type" dataType="Project.type" checkedValue="${artistry.getType()}" type="normal"/></a><a href="" class="present"><em class="present">></em>${artistry.project.name}</a></div>
    </div>
  </div>
