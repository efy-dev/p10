    ...
    <div class="craft-list">
        ...
        <ul class="list">
            <c:forEach items="${artRecommendList}" var="art" begin="0" end="3">
                <li>
                    <a href="<c:url value="/minglu/project/${art.artistry.id}"/>" title="${art.artistry.name}-非遗百科">
    ...
    <div class="craft-list">
        ...
        <ul class="list">
            <c:forEach items="${craftRecommendList}" var="craft" begin="0" end="3">
                <li>
                    <a href="<c:url value="/minglu/project/${craft.artistry.id}"/>" title="${craft.artistry.name}-非遗百科">
