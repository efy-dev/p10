        ...
        init: function (d, e) {
            return this.each(function () {
                ...
                if (h) {
                    ...
                    f.html('<span class="uploadify-button-text">' + '编辑头像' + "</span>").css({
                        height: j.height + "px",
    ...
    var a = {
        onDialogOpen: function () {
            ...
            if (i.itemTemplate == false) {
                i.itemTemplate = '<div id="${fileID}" class="uploadify-queue-item">					<div class="cancel">										</div>										<div class="uploadify-progress">						<div class="uploadify-progress-bar"><!--Progress Bar--></div>					</div>				</div>';
            }
