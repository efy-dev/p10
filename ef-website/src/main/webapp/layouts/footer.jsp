...
<div class="footer wh">
    <div class="service wh">
        ...
        <div class="line"></div>
        <div class="icon platform"><a href="<c:url value="/document/richTextView?group=ec.ptys"/>" target="_blank"
                                      title="平台优势">平台优势</a></div>
        <div class="line"></div>
    ...
    <div class="copyright wh">
        <div class="frlinksimg">
            ...
            <em class="line"></em>
            <a class="icon3" href="http://www.efeiyi.com" title="中国非物质文化遗产保护协会"></a>
            <em class="line"></em>
    ...
    <div class="wh authentication">
        <a href="http://gawa.bjchy.gov.cn/" target="_blank" title="网站域名备案"><img
                src="<c:url value="/scripts/images/authentication-0.png"/>" alt="网站域名备案"></a>
        <a href="http://www.miitbeian.gov.cn" target="_blank" title="网站域名备案"><img
                src="<c:url value="/scripts/images/authentication-1.png"/>" alt="网站域名备案"></a>
        <a href="http://www.baic.gov.cn/" target="_blank" title="企业信用信息备案"><img
                src="<c:url value="/scripts/images/authentication-2.png"/>" alt="企业信用信息备案"></a>
        <a href="<c:url value="/scripts/images/license.jpg"/>" target="_blank" title="企业营业执照"><img
                src="<c:url value="/scripts/images/authentication-3.png"/>" alt="企业营业执照 "></a>
    </div>
</div>
