...
<script src="<c:url value="/scripts/consumer/js/system.js?v=929"/>"></script>
<div class="footernew wh">
    ...
    <div class="servicenew wh">
        <div class="hd tct">
            <div class=" foremax">
                <dl class="fore">
                    <dt>帮助中心</dt>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.gwlc" target="_blank">购物流程</a></dd>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.zffs" target="_blank">支付方式</a></dd>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.psfs" target="_blank">配送方式</a></dd>
                </dl>
                <dl class="fore">
                    <dt>商家服务</dt>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.rzxz" target="_blank">入驻须知</a></dd>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.rzlc" target="_blank">入驻流程</a></dd>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.rzzx" target="_blank">入驻咨询</a></dd>
                </dl>
                <dl class="fore">
                    <dt>售后流程</dt>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.thlc" target="_blank">退货流程</a></dd>
                    <dd><a href="<%=PConst.HOSTNAME%>/document/helpCenter?group=ec.hhlc" target="_blank">换货流程</a></dd>
                </dl>
                <dl class="fore">
                    <dt>服务保障</dt>
    ...
    <div class="max-links wh">
        <div class="links wh">
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.gywm" target="_blank" title="关于我们">关于我们</a>
            <a class="line"></a>
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.ptys" target="_blank" title="平台优势">平台优势</a>
            <a class="line"></a>
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.cpyc" target="_blank" title="诚聘英才">诚聘英才</a>
            <a class="line"></a>
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.lxwm" target="_blank" title="联系我们">联系我们</a>
            <a class="line"></a>
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.yjfk" target="_blank" title="意见反馈">意见反馈</a>
            <a class="line"></a>
            <a href="<%=PConst.HOSTNAME%>/document/aboutUs?group=ec.fyjj" target="_blank" title="非遗简介">非遗简介</a>
        </div>
