...
public class ConsumerPurchaseOrderController {
    ...
    public String confirmGet(@PathVariable String orderId) {
        ...
        HashMap<String, String> purchaseOrderSerialMap = new HashMap<String, String>();
        purchaseOrderSerialMap.put("purchaseOrderSerial", purchaseOrderSerial);
        Map<String, String> templateMap = new HashMap<String, String>();
        templateMap.put("tpl_id", "1125941");
        smsProvider.post(phone, purchaseOrderSerialMap, "1125941");
        return "redirect:/order/myEfeiyi/list.do";
    }
