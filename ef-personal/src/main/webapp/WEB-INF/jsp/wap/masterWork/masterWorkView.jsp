...
<head>
  ...
  <link rel="stylesheet" href="<c:url value='/scripts/assets/css/layout.css'/>">
</head>
<body>
<div class="worksView">
    ...
    <div class="works-box bd">
      ...
      <div class="works-page2 bd">
        ...
        <div class="master_img">
          <div class="img"><img src="<c:url value='/scripts/assets/upload/user-img.jpg'/>" alt=""></div>
      ...
      <div class="works-page3 bd">
        ...
        <div class="bd txt-c">
          <a href="" class="link" title="查看详情">查看详情</a>
        </div>
      </div>
      <!--//End-- 关于技艺 -->
    </div>
      ...
      <ul>
        ...
        <li>
          <a href="" title="">
            ...
            <span class="fz11 black omitted">星航钧窑茶杯</span>
          </a>
        </li>
        <li>
          <a href="" title="">
