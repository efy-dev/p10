...
<div class="great">
  ...
  <div class="login-reg">
    ...
    <% } %>
    <%if(AuthorizationUtil.getMyUser()==null || AuthorizationUtil.getMyUser().getId() == null){ %>
    <a href="<c:url value='http://passport.efeiyi.com/login?service=http:%2F%2Fmaster.efeiyi.com%2Fef-person%2Fj_spring_cas_security_check'/>" class="btn-login" title="登录">登&nbsp;&nbsp;&nbsp;&nbsp;录</a>
