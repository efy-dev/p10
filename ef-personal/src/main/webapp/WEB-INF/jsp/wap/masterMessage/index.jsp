...
<article class="custom">
  <div data-am-widget="slider" class="am-slider am-slider-a1" data-am-slider='{&quot;directionNav&quot;:false}' >
    <ul class="am-slides">
      <li><img src="../shop2015/upload/box-hd-3-4.jpg"></li>
      <li><img src="../shop2015/upload/box-hd-3-4.jpg"></li>
      <li><img src="../shop2015/upload/box-hd-3-4.jpg"></li>
      <li><img src="../shop2015/upload/box-hd-3-4.jpg"></li>
    </ul>
  ...
  <div class="toolbar">
    <a class="item asso" href="#asso">
      <span><i class="bk-icon"></i></span>
      <span>分&nbsp;类</span>
    </a>
    <a class="item user" href="<c:url value='/masterMessage/forwardIndex.do'/>">
      <span><i class="icon2"></i></span>
      <span>传&nbsp;承&nbsp;人</span>
    </a>
    <a class="item coupon" href="#coupon">
      <span><i class="bk-icon1"></i></span>
      <span>工&nbsp;艺</span>
    </a>
  </div>
  <!--//End--toolbar-->
  <div class="box-hd">
    <ul class="ul-index-list">
      <li><a href="" title=""><img src="../shop2015/upload/box-hd-3-4.jpg" alt=""/></a></li>
    </ul>
  </div>
  <!--//End--铜的故事-->
  <div class="box-hd">
    ...
    <ul class="ul-index-list">
      <li>
        <a href="" title="">
          <img src="../shop2015/upload/box-hd-3-4.jpg" alt=""/>
