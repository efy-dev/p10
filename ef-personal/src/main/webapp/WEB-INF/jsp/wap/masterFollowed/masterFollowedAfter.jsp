...
<div class="great">
  <header class="am-header custom-header">
    <div class="am-header-left am-header-nav"> <a href="#chevron-left" class="chevron-left"></a> </div>
    <!-- //End--chevron-left-->
      ...
      <div class="tabs-bd">
        <div class="am-tab-panel am-active">
          ...
          <div class="suit">
            <div class="dynamic">
              ...
              <div class="dynamic-st">
                ...
                <div class="suit-st-ft">
                  <div class="suit-ft-left"><span>来自微信</span></div>
            ...
            <!-- //End-->
            <div class="dynamic">
              <div class="dynamic-hd"> <a class="suit-tx"><img class="am-circle" src="/scripts/assets/upload/120101-p4-1.jpg"></a>
                <div class="suit-name"><a href="#"><span>魏立中</span></a></div>
                <a class="suit-gz"><span>已关注</span></a> </div>
              <div class="dynamic-st">
                <div class="suit-st-text">
                  <p> <span>大家好,景泰蓝展览将在国庆节如期举办,届时欢迎大家前来参观,我也会到现场哦!</span> </p>
                </div>
                <div class="suit-st-ft">
                  <div class="suit-ft-left"><span>来自微信</span></div>
                  <div class="suit-ft-right"><span>1小时前</span></div>
...
<div class="login-reg">
  ...
  <a href="#login" class="btn-login" title="登录">登&nbsp;&nbsp;&nbsp;&nbsp;录</a> <a href="#reg" class="btn-reg">注&nbsp;&nbsp;&nbsp;&nbsp;册</a> </div>
<!--//End--login-reg-->
