                ...
                <div id="ji-ben-xin-xi">
                    ...
                    <table class="table-bg">
                        ...
                        <tr class="tr3">
                            ...
                            <td height="47" width="173" align="center"><ming800:status name='sex' dataType='Tenant.sex' checkedValue='${tenant.sex}' type='normal'/></td>
                            <td height="47" width="80" class="td-1 td-s">出生年月</td>
                            <td height="47" width="173" align="center">${tenant.birthday}</td>
                        </tr>
                        <tr class="tr4">
                            <td height="47" width="80"  class="td-1 td-s">籍贯</td>
                            <td height="47" width="173" align="center">${tenant.originProvince.name}</td>
                            <td height="47" width="80" class="td-1 td-s">现居地</td>
                            <td height="47" width="173" align="center">${tenant.presentAddress}</td>
                        </tr>
                        <tr class="tr5">
                            <td height="47" width="80"  class="td-1 td-s">代表作品</td>
                            <td height="47" width="173" align="center"></td>
                            <td height="47" width="80" class="td-1 td-s">级别</td>
                            <td height="47" width="173" align="center"><ming800:status name='sex' dataType='Tenant.level' checkedValue='${tenant.level}' type='normal'/></td>
                        </tr>
                        <tr class="tr6">
                            <td colspan="4"></td>
                        </tr>
