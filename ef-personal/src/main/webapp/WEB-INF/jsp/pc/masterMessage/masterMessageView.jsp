        ...
        <div class="detaile-comment ae">
          <form>
                    ...
                    <li class="ae">
                      ...
                      <div class="status ae">
                              ...
                              <li style="margin: 0;border-bottom: 0;" class="obtain">
                                <div class="ae">
                                  ...
                                  <div class="review-sr ae" style="display: none;">
                                    <textarea></textarea>
                                    <div class="btn1 ae">
                                      <input type="button" onclick="subComment(this,'${sub.id}');" class="btn" value="评论">
                                      <!--<a href="#">取消</a>-->
                                    </div>
                                  </div>
                                </div>
                        ...
                        <div class="review ae" style="display: none;">
                          <textarea></textarea>
                          <div class="btn1 ae">
                            <input type="submit" onclick="subComment(this,'${comm.id}');" class="btn" value="评论">
                          </div>
                        </div>
                      </div>
                    </li>
            ...
            <div class="review ae">
              <textarea></textarea>
              <div class="btn1 ae">
                <input type="submit" onclick="msgComment(this,'${msg.id}');" class="btn" value="评论">
                <!--<a href="#">取消</a>-->
              </div>
            </div>
          </form>
...
<script>
  ...
  function subComment(o,commId,fatherId){
