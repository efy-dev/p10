                    ...
                    <div class="box">
                        ...
                        <p class="txt">
                            <div class="img-mutual-text1">
                                ...
                                <p>
                                    <c:choose>
                                        <c:when test="${fn:length(tenant.brief)  > 25}">
                                            <a href="http://${tenant.name}.efeiyi.com:${pageContext.request.serverPort}${pageContext.request.contextPath}" target="_blank">${fn:substring(tenant.brief,0 ,25 ) }......</a>
                                        </c:when>
                                        <c:otherwise>
                                            <a href="http://${tenant.name}.efeiyi.com:${pageContext.request.serverPort}${pageContext.request.contextPath}" target="_blank">${tenant.brief}</a>
                                        </c:otherwise>
                                    </c:choose>
                                </p>
                            </div>
                    ...
                    <div class="box">
                        ...
                        <div class="img-mutual-text1">
                            ...
                            <p>
                                <c:choose>
                                    <c:when test="${fn:length(tenant.brief)  > 25}">
                                        <a href="http://${tenant.name}.efeiyi.com:${pageContext.request.serverPort}${pageContext.request.contextPath}" class="img-mutual-text1-a" target="_blank">${fn:substring(tenant.brief,0 ,25 ) }......</a>
                                    </c:when>
                                    <c:otherwise>
                                        <a href="http://${tenant.name}.efeiyi.com:${pageContext.request.serverPort}${pageContext.request.contextPath}" class="img-mutual-text1-a" target="_blank">${tenant.brief}</a>
                                    </c:otherwise>
                                </c:choose>
                            </p>
                        </div>
