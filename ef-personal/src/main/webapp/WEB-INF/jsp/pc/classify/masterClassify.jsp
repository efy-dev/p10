...
<div class="list-find">
  ...
  <div class="list-f-select">
    ...
    <div class="f-select-group">
      <div class="select-head">
        <span>级别：</span>
        <strong><a onclick="getData(this,'<c:url value="/masterCategory/getClassifyData.do?qm=plistMaster_all&pageEntity.size=6&pageEntity.index="/>')"  class="active">全部</a></strong>
      </div>
      <ul class="select-list" id="levelClassify">
    ...
    <div class="f-select-group cl-act">
      <div class="select-head">
        <span>地区：</span>
        <strong><a about="0" onclick="getData(this,'<c:url value="/masterCategory/getClassifyData.do?qm=plistMaster_all&pageEntity.size=6&pageEntity.index="/>')" class="active">全部</a></strong>
      </div>
            ...
            var box = "<li>"+
                    ...
                    "                                    <ul class=\"list-pic\">";
                            if(data[i].works != null && data[i].works.length > 0){
                              ...
                              for(var j in obj){
                                if(j >= 0 && j < 4){
                                  box += "<li><a href=\"<c:url value='/masterMessage/getWorkDetails/'/>"+obj[j].id+"\"><img src=\"http://tenant.oss-cn-beijing.aliyuncs.com/"+obj[j].pictureUrl+"\"></a> </li>";
                                }
                              }
                            }
                    box +="                                    </ul>"+
