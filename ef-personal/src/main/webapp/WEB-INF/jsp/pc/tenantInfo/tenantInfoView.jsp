...
<!--资讯详情-->
<div id="page-nav">
  <p><a href="${pageContext.request.contextPath}/tenant/ten">首页</a><span id="zpxq-1"><a href="${pageContext.request.contextPath}/tenantInfo/listTenantInfo.do?conditions=tenant.id:${tenantNews.tenant.id}">资讯</a></span><span>${tenantNews.title}</span></p>
</div>
