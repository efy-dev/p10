...
<link rel="shortcut icon" type="image/x-icon" href="<c:url value='/scripts/assets/images/favicon.ico'/>">
<link type="text/css" rel="stylesheet" href="<c:url value='/scripts/assets/pc/css/amazeui.min.css?v=20150831'/>">
<link rel="stylesheet" type="text/css" href="<c:url value="/scripts/assets/pc/css/cyclopedia.css?v=150814"/> ">
